...
%       [cA,cH,cV,cD]=swt2(Gray,1,'haar');
        
    [CLBP_S,CLBP_M,CLBP_C] = CGRILBP(Gray,R,P,patternMappingriu2,'x');
...
SCP=ClassifyOnNN(DM,trainClassIDs,testClassIDs)
...
MCP=ClassifyOnNN(DM,trainClassIDs,testClassIDs)
...
MCCP=ClassifyOnNN(DM,trainClassIDs,testClassIDs)
...
S_MCCP=ClassifyOnNN(DM,trainClassIDs,testClassIDs)
...
SMCP=ClassifyOnNN(DM,trainClassIDs,testClassIDs)
...
SMCCP=ClassifyOnNN(DM,trainClassIDs,testClassIDs)